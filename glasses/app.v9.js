(function () {
  ...
  function timerHtml() {
    var head = '<div class="head"><div class="brand">IRONMATH</div><div class="screen">REST</div>' + verHtml() + '</div>';
    if (!timerState) {
  ...
  function stampHtml() {
    ...
    return '<div class="stamp">' + when + '</div>';
  }

  function verHtml() {
    return '<div class="ver">' + HUD_VERSION + '</div>';
  }
  ...
  function paint() {
    ...
    if (view === 'timer') {
      ...
      root.className = 'hud hud-load';
      root.innerHTML = emptyLoad
        ? '<div class="head"><div class="brand">IRONMATH</div>' + verHtml() + '</div>' +
          '<p class="hint">Type Load on the phone, then tap Open on glasses.</p>' +
          stampHtml()
        : '<div class="target-block">' +
          '<div class="target-row"><div class="kicker target-kicker">TARGET</div><div class="ver">' + HUD_VERSION + '</div></div>' +
      ...
      root.className = 'hud';
      root.innerHTML =
        '<div class="head"><div class="brand">IRONMATH</div><div class="screen">LB / KG</div>' + verHtml() + '</div>' +
